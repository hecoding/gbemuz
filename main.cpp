...
//    Cartrigde cart("../../gbemu/roms/cpu_instrs/individual/10-bit ops.gb"); // unimplemented
//    Cartrigde cart("../../gbemu/roms/cpu_instrs/individual/11-op a,(hl).gb"); // unimplemented
    MMU mmu(cart);
    CPU cpu(mmu);
    bool done = false;
    size_t cycles;
